  ...
  return (
    <div className="w-full bg-[linear-gradient(52deg,#d4c8ff_0%,#c4f2ff_100%)] text-white py-16 px-6 flex justify-center">
      <div className="max-w-6xl w-full bg-[#0D1224] border border-[#1a2442] rounded-3xl px-6 py-10 shadow-2xl">
        ...
        <motion.div
          initial={false}
          className="flex justify-between max-w-3xl mx-auto text-gray-300 text-lg font-medium mb-12 relative gap-6 overflow-x-auto no-scrollbar"
        >
          {" "}
          {tabs.map((tab) => (
            <button
              ...
              className="relative px-2 pb-1 shrink-0"
            >
              <motion.span
              ...
              {tab === activeTab && (
                <motion.div
                  ...
                  className="absolute left-0 right-0 h-[3px] bg-violet-400 rounded-full"
                  style={{ bottom: -2 }}
                />
              )}
            </button>
